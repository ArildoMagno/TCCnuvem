...
def calculate_similar_sets_in_docs(doc_segmented1, doc_segmented2):
    ...
    for set1 in doc_segmented1:
        for set2 in doc_segmented2:
            similar_sets_temp = similarity_between_sets(set1[1], set2[1])
...
def similarity_between_sets(set1, set2):
    # calculo secao 4.3.2
    anB = []
    bmA = []
...
def degree_resemblance(qntd_similar_sets, tam):
    # Trabalho HTML
